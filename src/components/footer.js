		...
		<div className="footer">
			...
			<div className="footer__nav">
				...
				<div className="footer-section">
					...
					<div className="footer-text">
						<p>
							<FontAwesomeIcon className="mr-1/2" icon={faPhone} />+0800-123-4567
						</p>
						<p>
							<FontAwesomeIcon className="mr-1/2" icon={faEnvelope} />info@domain.com
						</p>
					</div>
				</div>
				<div className="footer-section">
				...
				<div className="footer-section">
					...
					<div className="footer-text">
						<p className="social-item__container">
							<FontAwesomeIcon className="mr-1/2" icon={faInstagram} />Instagram
						</p>
						<p className="social-item__container">
							<FontAwesomeIcon className="mr-1/2" icon={faFacebook} />Facebook
						</p>
						<p className="social-item__container">
							<FontAwesomeIcon className="mr-1/2" icon={faTwitter} />Twitter
						</p>
					</div>
				</div>
			</div>
