  ...
  return (
    <div>
      <SectionContent 
        ...
        richText={data.contentfulPageSingle.pageSections[0].contentRichText.richText.richText}
        image={data.contentfulPageSingle.pageSections[0].contentImage.fluid}
      />
      <SectionDivider dividerType={data.contentfulPageSingle.pageSections[1].dividerType}/>
    </div>
  )
}
